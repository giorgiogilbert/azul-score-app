...
const {boardGrid, toggleBoardCell, penaltyGrid, togglePenaltyCell} = boardComposable
...
const handleResetGame = () => {
  if( isCurrentGameEnded.value || confirm("Vuoi resettare la partita? Il punteggio attuale sarà perso.")){
    resetGame()
  }
}
...
<template>
  <main class="container">
    ...
    <div class="board">
      ...
      >
        <button
            ...
            class="cell"
            :class="{ filled: cell }"
            :style="{ backgroundImage: `url(${getCellImage(rowIndex, colIndex)})` }"
    ...
    <div v-else>
      ...
      <p>Punteggio finale: <b>{{ game.score }}</b></p>
    </div>
